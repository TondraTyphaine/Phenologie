...
humidity_month2020 %>% 
  filter(!is.na(`Hr(55)`)) %>% 
  print() ->
  humidity_month2020_Hr

# Pic maximal journalier  sur l'annee
picHR2020_X <- which.max(humidity2020_Hr$`Hr(55)`) #position
picHR2020_Y <- max(humidity2020_Hr$`Hr(55)`) #valeur
dates2020_Hr <- humidity2020_Hr$date

# Pic minimal journalier  sur l'annee
picminHR2020_X <- which.min(humidity2020_Hr$`Hr(55)`)
picminHR2020_Y <- min(humidity2020_Hr$`Hr(55)`)

# Pic maximal mensuel de pluie sur l'annee
maxHR2020_X <- which.max(humidity_month2020_Hr$`Hr(55)`)
maxHR2020_Y <- max(humidity_month2020_Hr$`Hr(55)`)
dates2020_Hr_bis <-  humidity_month2020_Hr$date

#Pic minimum mensuel sur l'annee
minHR2020_X <- which.min(humidity_month2020_Hr$`Hr(55)`)
minHR2020_Y <- min(humidity_month2020_Hr$`Hr(55)`)
...
humidity_month2021 %>% 
  filter(!is.na(`Hr(55)`)) %>% 
  print() ->
  humidity_month2021_Hr

humidity_month2022 %>% 
  filter(!is.na(`Hr(55)`)) %>% 
  print() ->
  humidity_month2022_Hr

humidity_month2023 %>% 
  filter(!is.na(`Hr(55)`)) %>% 
  print() ->
  humidity_month2023_Hr

humidity_month2024 %>% 
  filter(!is.na(`Hr(55)`)) %>% 
  print() ->
  humidity_month2024_Hr


sum(is.na(humidity_month2024_Hr$`Hr(55)`))
...
ggplot(data = humidity_Hr) +
  geom_line(data = humidity2020_Hr, aes(x = date, y = `Hr(55)`), colour = "#E6AB02") +
  geom_line(data = humidity2021_Hr, aes(x = date, y = `Hr(55)`), colour = "#D95F02") +
  geom_line(data = humidity2022_Hr, aes(x = date, y = `Hr(55)`), colour = "#E7298A") +
  geom_line(data = humidity2023_Hr, aes(x = date, y = `Hr(55)`), colour = "#7570B3") +
  geom_line(data = humidity2024_Hr, aes(x = date, y = `Hr(55)`), colour = "#66A61E") +
  
  # Pics maximaux
  geom_point(aes(x = dates2020_Hr[picHR2020_X], y = picHR2020_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2021_Hr[picHR2021_X], y = picHR2021_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2022_Hr[picHR2022_X], y = picHR2022_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2023_Hr[picHR2023_X], y = picHR2023_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2024_Hr[picHR2024_X], y = picHR2024_Y),
             colour = "grey40", size = 1) +
  
  # Pics minimaux
  geom_point(aes(x = dates2020_Hr[picminHR2020_X], y = picminHR2020_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2021_Hr[picminHR2021_X], y = picminHR2021_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2022_Hr[picminHR2022_X], y = picminHR2022_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2023_Hr[picminHR2023_X], y = picminHR2023_Y),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2024_Hr[picminHR2024_X], y = picminHR2024_Y),
             colour = "grey40", size = 1) +
  
  # Annotation des maximums
  annotate("text", x = dates2020_Hr[picHR2020_X], y =picHR2020_Y+1,
           label = round(picHR2020_Y, digits = 2), colour = "grey40", size = 3) +
  annotate("text", x = dates2021_Hr[picHR2021_X], y = picHR2021_Y+1, 
           label = round(picHR2021_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2022_Hr[picHR2022_X]-5, y = picHR2022_Y+1, 
           label = round(picHR2022_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2023_Hr[picHR2023_X], y = picHR2023_Y+1, 
           label = round(picHR2023_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2024_Hr[picHR2024_X], y = picHR2024_Y+1, 
           label = round(picHR2024_Y, digits = 2),colour = "grey40", size = 3) +
  
  # Annotations des minimums
  annotate("text", x = dates2020_Hr[picminHR2020_X], y = picminHR2020_Y-1,
           label = round(picminHR2020_Y, digits = 2), colour = "grey40", size = 3) +
  annotate("text", x = dates2021_Hr[picminHR2021_X], y = picminHR2021_Y-1, 
           label = round(picminHR2021_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2022_Hr[picminHR2022_X], y = picminHR2022_Y-1, 
           label = round(picminHR2022_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2023_Hr[picminHR2023_X], y = picminHR2023_Y-1, 
           label = round(picminHR2023_Y, digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2024_Hr[picminHR2024_X], y = picminHR2024_Y-1, 
           label = round(picminHR2024_Y, digits = 2),colour = "grey40", size = 3) +
  
  # Marquage des maximums
  geom_vline(xintercept = dates2020_Hr[picHR2020_X],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2021_Hr[picHR2021_X],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2022_Hr[picHR2022_X],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2023_Hr[picHR2023_X],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2024_Hr[picHR2024_X],
             col = "black", linetype = "dashed") +
...
bind_rows(humidity_month2020_Hr) %>% 
  bind_rows(humidity_month2021_Hr[1,]) %>% 
  print() ->
  humidity_month2020_Hrbis

bind_rows(humidity_month2021_Hr) %>% 
  bind_rows(humidity_month2022_Hr[1,]) %>% 
  print() ->
  humidity_month2021_Hrbis

bind_rows(humidity_month2022_Hr) %>% 
  bind_rows(humidity_month2023_Hr[1,]) %>% 
  print() ->
  humidity_month2022_Hrbis

bind_rows(humidity_month2023_Hr) %>% 
  bind_rows(humidity_month2024_Hr[1,]) %>% 
  print() ->
  humidity_month2023_Hrbis

ggplot() +
  geom_line(data = humidity_month2020_Hrbis, aes(x = date, y = `Hr(55)`),colour = "#E6AB02") +
  geom_line(data = humidity_month2021_Hrbis, aes(x = date, y = `Hr(55)`), colour = "#D95F02") +
  geom_line(data = humidity_month2022_Hrbis, aes(x = date, y = `Hr(55)`), colour = "#E7298A") +
  geom_line(data = humidity_month2023_Hrbis, aes(x = date, y = `Hr(55)`), colour = "#7570B3") +
  geom_line(data = humidity_month2024_Hr, aes(x = date, y = `Hr(55)`), colour = "#66A61E") +
  
  # Pics maximaux
  geom_point(aes(x = dates2020_Hr_bis[maxHR2020_X], y = humidity_month2020_Hrbis$`Hr(55)`[maxHR2020_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2021_Hr_bis[maxHR2021_X], y = humidity_month2021_Hrbis$`Hr(55)`[maxHR2021_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2022_Hr_bis[maxHR2022_X], y = humidity_month2022_Hrbis$`Hr(55)`[maxHR2022_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2023_Hr_bis[maxHR2023_X], y = humidity_month2023_Hrbis$`Hr(55)`[maxHR2023_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2024_Hr_bis[maxHR2024_X], y = humidity_month2024_Hr$`Hr(55)`[maxHR2024_X]),
             colour = "grey40", size = 1) +
  
  # Pics minimaux
  geom_point(aes(x = dates2020_Hr_bis[minHR2020_X], y = humidity_month2020_Hrbis$`Hr(55)`[minHR2020_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2021_Hr_bis[minHR2021_X], y = humidity_month2021_Hrbis$`Hr(55)`[minHR2021_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2022_Hr_bis[minHR2022_X], y = humidity_month2022_Hrbis$`Hr(55)`[minHR2022_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2023_Hr_bis[minHR2023_X], y = humidity_month2023_Hrbis$`Hr(55)`[minHR2023_X]),
             colour = "grey40", size = 1) +
  geom_point(aes(x = dates2024_Hr_bis[minHR2024_X], y = humidity_month2024_Hr$`Hr(55)`[minHR2024_X]),
             colour = "grey40", size = 1) +
  
  # Annotations pics maximaux
  annotate("text", x = dates2020_Hr_bis[maxHR2020_X], y = humidity_month2020_Hrbis$`Hr(55)`[maxHR2020_X]+0.4, 
           label = round(humidity_month2020$`Hr(55)`[maxHR2020_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2021_Hr_bis[maxHR2021_X], y = humidity_month2021_Hrbis$`Hr(55)`[maxHR2021_X]+0.4, 
           label = round(humidity_month2021$`Hr(55)`[maxHR2021_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2022_Hr_bis[maxHR2022_X], y = humidity_month2022_Hrbis$`Hr(55)`[maxHR2022_X]+0.4, 
           label = round(humidity_month2022$`Hr(55)`[maxHR2022_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2023_Hr_bis[maxHR2023_X], y = humidity_month2023_Hrbis$`Hr(55)`[maxHR2023_X]+0.4, 
           label = round(humidity_month2023$`Hr(55)`[maxHR2023_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2024_Hr_bis[maxHR2024_X], y = humidity_month2024_Hr$`Hr(55)`[maxHR2024_X]+0.4, 
           label = round(humidity_month2024$`Hr(55)`[maxHR2024_X], digits = 2),colour = "grey40", size = 3) +
  
  # Annotations des pics minimaux
  annotate("text", x = dates2020_bis[minHR2020_X], y = humidity_month2020_Hrbis$`Hr(55)`[minHR2020_X]-0.4, 
           label = round(humidity_month2020$`Hr(55)`[minHR2020_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2021_Hr_bis[minHR2021_X], y = humidity_month2021_Hrbis$`Hr(55)`[minHR2021_X]-0.4, 
           label = round(humidity_month2021$`Hr(55)`[minHR2021_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2022_Hr_bis[minHR2022_X], y = humidity_month2022_Hrbis$`Hr(55)`[minHR2022_X]-0.4, 
           label = round(humidity_month2022$`Hr(55)`[minHR2022_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2023_Hr_bis[minHR2023_X], y = humidity_month2023_Hrbis$`Hr(55)`[minHR2023_X]-0.4, 
           label = round(humidity_month2023$`Hr(55)`[minHR2023_X], digits = 2),colour = "grey40", size = 3) +
  annotate("text", x = dates2024_Hr_bis[minHR2024_X], y = humidity_month2024_Hr$`Hr(55)`[minHR2024_X]-0.4, 
           label = round(humidity_month2024$`Hr(55)`[minHR2024_X], digits = 2),colour = "grey40", size = 3) +
  
  # Delimitation des annees
  geom_vline(xintercept = dates2021_Hr_bis[1],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2022_Hr_bis[1],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2023_Hr_bis[1],
             col = "black", linetype = "dashed") +
  geom_vline(xintercept = dates2024_Hr_bis[1],
             col = "black", linetype = "dashed") +
